<template>
  <div>
    <div class="mb-8 flex items-center gap-3">
      <h2 class="text-3xl font-bold text-blue-900">Performa GBPUSD</h2>
    ...
    <div v-else>
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          <p class="text-sm text-gray-500 font-medium mb-1">Total Pips GBPUSD</p>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          <h3 class="text-lg font-bold text-gray-800 mb-4">Equity Curve GBPUSD</h3>
...
// Ajaibnya Composable: Tinggal panggil fungsi dengan parameter 'GBPUSD'
const { trades, loading, errorMsg, fetchTrades, totalTrades, totalPips, winRate, profitFactor, avgRR, equityChartData, monthlyChartData } = useDashboard('GBPUSD')
